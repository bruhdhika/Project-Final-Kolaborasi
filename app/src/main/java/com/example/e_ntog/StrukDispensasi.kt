...
class StrukDispensasi : AppCompatActivity() {
    ...
    private fun saveStrukAsImage(view: View) {
        ...
        val filename = "struk_dispensasi_${System.currentTimeMillis()}.png"
        ...
        fos?.use {
            ...
            Toast.makeText(this, "Struk Dispensasi disimpan di Galeri/Pictures/E-Zin", Toast.LENGTH_LONG).show()
        } ?: run {
